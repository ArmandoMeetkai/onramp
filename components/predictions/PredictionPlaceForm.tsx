...
interface PredictionPlaceFormProps {
  ...
  onPlace: (position: "yes" | "no", asset: "BTC" | "ETH" | "SOL", usdAmount: number) => Promise<boolean>
}
...
export function PredictionPlaceForm({ holdings, onPlace }: PredictionPlaceFormProps) {
      ...
      >
        ...
        >
          <div className="flex-1">
            <p className="text-sm font-semibold">You don&apos;t have any crypto yet</p>
            <p className="mt-1 text-xs text-muted-foreground">
              Buy BTC, ETH, or SOL in your practice portfolio to start predicting.
            </p>
          </div>
  ...
  return (
    ...
    >
      ...
      {hasNoHoldings ? (
        ...
        >
          <div className="flex-1">
            <p className="text-sm font-semibold">You don&apos;t hold any {selectedAsset} yet</p>
            <p className="mt-1 text-xs text-muted-foreground">
              Buy {selectedAsset} in your practice portfolio or choose another coin above.
            </p>
          </div>
          <ArrowRight className="h-4 w-4 text-accent transition-transform group-hover:translate-x-0.5" />
        </Link>
